...
import { UserMode } from '@gid/core/config/model/user-mode.enum';
import { Store, select } from '@ngrx/store';
import { IAppState } from '@gid/core/app-store/app.state';
import { selectConfigSuccess } from '@gid/core/config/store/selectors/config.selector';
import { UpdateConfig } from '@gid/core/config/store/actions/config.actions';
import { IConfig } from '@gid/core/config/model/config.interface';
import { LevelKeys } from './model/level-keys';

@Component({
  selector: 'gid-config-manager',
